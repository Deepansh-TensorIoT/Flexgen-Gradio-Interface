...
interface.launch(inbrowser=True, ssl_verify=False, server_name="0.0.0.0", favicon_path="media/cropped-flexgen-icon-32x32.png", server_port=7865,ssl_certfile="./cert.pem",ssl_keyfile="./key.pem", auth=authenticate)
